<template>
    <div class="advertiser-sidebar">
      <div class="logo-container">
        <div class="logo">ReviewCampus</div>
      </div>
      <div class="menu-container">
        <div class="menu-item" :class="{ active: isActive('/advertiser/dashboard') }">
          <router-link to="/advertiser/dashboard">
            <div class="menu-icon">
        ...
        <div class="menu-item" :class="{ active: isActive('/advertiser/campaigns') }">
          <router-link to="/advertiser/campaigns">
            <div class="menu-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-text">캠페인 관리</span>
          </router-link>
        </div>
        <div class="menu-item" :class="{ active: isActive('/advertiser/reviewers') }">
          <router-link to="/advertiser/reviewers">
            <div class="menu-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-text">리뷰어 관리</span>
          </router-link>
        </div>
        <div class="menu-item" :class="{ active: isActive('/advertiser/reports') }">
          <router-link to="/advertiser/reports">
            <div class="menu-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-text">통계 및 리포트</span>
          </router-link>
        </div>
        <div class="menu-item" :class="{ active: isActive('/advertiser/payments') }">
          <router-link to="/advertiser/payments">
            <div class="menu-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="menu-text">결제 및 정산</span>
          </router-link>
        </div>
        <div class="menu-item" :class="{ active: isActive('/advertiser/settings') }">
          <router-link to="/advertiser/settings">
            <div class="menu-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
